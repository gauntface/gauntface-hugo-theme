...
const gfThemeDir = path.join(styleguideDir, 'themes', 'gauntface');
...
gulp.task('styleguide-gf-theme', cleanAndRun(gfThemeDir, gftheme.copyTheme))
...
gulp.task('styleguide-html', html.gulpProcessFiles({
